	...
	<head>
		...
		<style type="text/css">
			...
			*   http://pugetworks.com/2011/04/css-media-queries-for-targeting-different-mobile-devices/ ;
			...
			table.tblresumen td, table.tblresumen th {
			  border: 1px solid #FFFFFF;
			  padding: 3px 2px;
			}
			table.tblresumen tbody td {
			  font-size: 13px;
			}
			table.tblresumen tbody tr:nth-child(even) {
			  background: #D0E4F5;
			}
			table.tblresumen thead {
			  background: #0B6FA4;
			  border-bottom: 5px solid #FFFFFF;
			}
			table.tblresumen thead th {
			  font-size: 17px;
			  font-weight: bold;
			  color: #FFFFFF;
			  text-align: center;
			...
			table.tblresumen thead th:first-child {
			  border-left: none;
			}

			table.tblresumen tfoot {
			  font-size: 14px;
			  font-weight: bold;
			  color: #333333;
			  border-top: 2px solid #444444;
			}
			table.tblresumen tfoot td {
			  font-size: 14px;
			  text-align: right;
			}
		</style>
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:24px;font-weight:normal;margin-bottom:5px;text-align:center;">
																			AUREUSRLG.COM<br/><br/>
																			Nuevo Contacto</h1>
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div id="resumen">
																			<p style="text-align: left;"><strong>Nombres:</strong>&nbsp;<?php echo $_POST["nombres"] ?>.
																			<br/><br/>
																			<strong>Correo:</strong>&nbsp;<?php echo $_POST["correo"] ?>.
																			<br/><br/>
																			<strong>Teléfono:</strong>&nbsp;<?php echo $_POST["telefono"] ?>.														<br/><br/>
																			<strong>Asunto:</strong>&nbsp;<?php echo $_POST["asunto"] ?>.
												...
												<table border="0" cellpadding="0" cellspacing="0" width="500" class="flexibleContainer">
													<tr>
														<td valign="top" width="500" class="flexibleContainerCell">
															...
															<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
																<tr>
																	<td align="left" valign="top" class="flexibleContainerBox" style="background-color:#33363b;">
																		<table border="0" cellpadding="30" cellspacing="0" width="100%" style="max-width:100%;">
																			<tr>
																				<td align="left" class="textContent">
																					<h3 style="color:#FFFFFF;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">CONTACTO AUREUSRLG</h3>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
																							Linea de atención: 57(1) 2450219<br/>
																							Celular: 3103241988<br/>
																							Dirección: calle 39b# 21 - 54 <br/>Barrio La Soledad (Bogotá - Colombia)
																					</div>
																				</td>
																			</tr>
																		</table>
